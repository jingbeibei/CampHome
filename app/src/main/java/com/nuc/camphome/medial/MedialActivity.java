 ...
 */
public class MedialActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        init();  //初始化数据
        //url = "http://202.207.177.28:88/UploadFiles/Media/20160301001.mp4";   //视频播放地址
        setListener();   //绑定相关事件
    }
    private void init() {
        mediaPlayer = new MediaPlayer();   //创建一个播放器对象
        update = new upDateSeekBar();  //创建更新进度条对象
        setContentView(R.layout.medially);   //加载布局文件
        ...
        mediaPlayer
                .setOnCompletionListener(new MediaPlayer.OnCompletionListener() { //视频播放完成
                    ...
                    public void onCompletion(MediaPlayer mp) {
                        flag = false;
                        bt.setBackgroundResource(R.mipmap.movie_play_bt);
                    }
                });
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mediaPlayer.isPlaying()) {
                    ...
                    mediaPlayer.start();
                    bt.setBackgroundResource(R.mipmap.movie_stop_bt);
