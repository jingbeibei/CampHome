package com.nuc.camphome.medial;
...
public class MedialListActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medial_list);
...
//        mAdapter.notifyDataSetChanged();
    ...
    private void initView() {
        ...
        if (type == 1) {
            BarTitle.setText("网络课堂");
        }
        if (type == 2) {
            BarTitle.setText("自选教育");
        }
        if (type == 3) {
            BarTitle.setText("影音娱乐");
        }
        ...
        BackImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityCollector.removeActivity(MedialListActivity.this);
            }
        });
    }
    ...
    public void loadDate(int Index, int size, String url) {
        ...
        url = url + "times=" + times + "&code=" + code + "&applicationID=" + applicationid + "&blockID=" + type + " &pageindex=" + Index + "&pagesize=" + size ;
    ...
    private NewsAdapter.OnItemClickListener mOnItemClickListener = new NewsAdapter.OnItemClickListener() {
        ...
        public void onItemClick(View view, int position) {
            ...
            Intent intent = new Intent(MedialListActivity.this,MedialActivity.class);
            intent.putExtra("FileUrl",news.getFileUrl());
